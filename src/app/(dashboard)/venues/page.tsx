...
import { MapPinIcon, UsersIcon, SearchIcon, CalendarCheckIcon } from "lucide-react";
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {filteredVenues.map((venue) => (
            <Card key={venue.id} className="glass flex flex-col">
              ...
              <CardFooter>
                <Dialog open={dialogOpen && selectedVenue?.id === venue.id} onOpenChange={(open) => { setDialogOpen(open); if (!open) { setDate(undefined); setBookedDates(new Set()); setRangeMode(false); setDateRange({}); setRangeSummary(null); setStartTime("09:00"); setEndTime("17:00"); } }}>
